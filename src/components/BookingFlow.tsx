      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
        <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl border border-blue-100 p-8">
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600">Service: {provider.specialty || provider.name}</p>
          ...
          <form onSubmit={handlePayment} className="space-y-6">
            <div>
              <label htmlFor="nameOnCard" className="block text-gray-700 font-medium mb-2">Name on Card</label>
              <input
                id="nameOnCard"
                type="text"
